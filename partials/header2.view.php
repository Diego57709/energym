...
<head>
  ...
  <style>
    ...
    @media (max-width: 768px) {
      .header-icon { width: 5rem; }
      .header-cliente { font-size: 1.5rem; padding: 0.5rem 1rem; }
      .dropdown-icon { width: 5rem; }
      .inscribete-btn a { font-size: 1.5rem; }
      .offcanvas a.dropdown-item { font-size: 1.3rem; }
    }
    @media (max-width: 480px) {
      .header-cliente { font-size: 1.2rem; padding: 0.4rem 0.8rem; }
      .dropdown-icon { width: 4rem; }
      .inscribete-btn a { font-size: 1.2rem; }
      .offcanvas a.dropdown-item { font-size: 1.1rem; }
    }
  </style>
</head>
<body>
