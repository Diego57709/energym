...
$sql = "SELECT google_2fa_secret FROM entrenadores WHERE entrenador_id = ?";
...
$existingSecret = $entrenador['google_2fa_secret'] ?? '';
    ...
    <div class="main">
        <div class="container my-5" style="max-width: 600px;">
            <div class="card p-4">
                ...
                <form action="entrenadorVerificar2FA.php" method="POST" class="text-center">
