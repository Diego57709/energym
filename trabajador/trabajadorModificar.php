...
$sql = "SELECT * FROM trabajadores WHERE trabajador_id = '$id_usuario'";
$result = mysqli_query($conn, $sql);
$trabajador = mysqli_fetch_assoc($result);

if (!$trabajador) {
    die("Error al obtener los datos del trabajador.");
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlUpdate = "UPDATE trabajadores SET 
                    nombre = '$nombre', 
                    apellidos = '$apellidos',
                    email = '$email', 
                    telefono = '$telefono', 
                  ...
                  WHERE trabajador_id = '$id_usuario'";
...
<body>
                    ...
                    <form method="POST" action="trabajadorModificar.php" class="form-section" id="datos-form">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" value="<?= htmlspecialchars($trabajador['nombre']) ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label for="apellidos" class="form-label fw-bold">Apellidos</label>
                                <input type="text" class="form-control" id="apellidos" name="apellidos" value="<?= htmlspecialchars($trabajador['apellidos'] ?? '') ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mt-3">
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="email" name="email" value="<?= htmlspecialchars($trabajador['email']) ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label for="telefono" class="form-label fw-bold">Teléfono</label>
                                <input type="text" class="form-control" id="telefono" name="telefono" value="<?= htmlspecialchars($trabajador['telefono']) ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mt-3">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="direccion" name="direccion" value="<?= htmlspecialchars($trabajador['direccion']) ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mt-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="codigo_postal" name="codigo_postal" value="<?= htmlspecialchars($trabajador['codigo_postal']) ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label for="fecha_nacimiento" class="form-label fw-bold">Fecha de Nacimiento</label>
                                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" value="<?= htmlspecialchars($trabajador['fecha_nacimiento']) ?>" required>
                            </div>
                        </div>
    ...
    <script>
        ...
        const originalData = {
            nombre: '<?= htmlspecialchars($trabajador['nombre']) ?>',
            apellidos: '<?= htmlspecialchars($trabajador['apellidos'] ?? '') ?>',
            email: '<?= htmlspecialchars($trabajador['email']) ?>',
            telefono: '<?= htmlspecialchars($trabajador['telefono']) ?>',
            direccion: '<?= htmlspecialchars($trabajador['direccion']) ?>',
            codigo_postal: '<?= htmlspecialchars($trabajador['codigo_postal']) ?>',
            fecha_nacimiento: '<?= htmlspecialchars($trabajador['fecha_nacimiento']) ?>',
        };
