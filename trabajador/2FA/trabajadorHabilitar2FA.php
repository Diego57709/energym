...
$sql = "SELECT google_2fa_secret FROM trabajadores WHERE trabajador_id = ?";
...
$existingSecret = $trabajador['google_2fa_secret'] ?? '';
    ...
    <div class="main">
        <div class="container my-5" style="max-width: 600px;">
            <div class="card p-4">
                ...
                <form action="trabajadorVerificar2FA.php" method="POST" class="text-center">
